...
class StoneMapComponent(PolyMapComponent):
    ...
    def update_instance_scale(self):
        ...
        self._workspace.itemconfig(self._object_z0_id, width=(self._workspace.get_zoom() * 80 / 320))
        self._workspace.itemconfig(self._object_z1_id, width=(self._workspace.get_zoom() * 40 / 320))
